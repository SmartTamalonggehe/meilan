...
<button type="button" href="kartuBerobat/{{ $model->id }}" id="hapus" class="btn btn-light waves-effect waves-light"> <i class="fa fa fa-trash-o"></i> <span>Delete</span> </button>
</div>
